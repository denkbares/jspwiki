...
import static org.apache.wiki.multiWiki.MultiWikiTestData.PAGE_NAME_B1;
...
public class MultiWikiNestedExistingLinksBTest extends AbstractMultiWikiTest{
	...
	public void testExistingPageLinksA() throws Exception {
		...
		testEngine.saveText(WIKI_PREFIX_B + SubWikiUtils.SUB_FOLDER_PREFIX_SEPARATOR + PAGE_NAME_B1, MultiWikiNestedNonExistingLinksBTest.PAGE_CONTENT_B1);
		...
		Assertions.assertEquals("<a class=\"wikipage\" href=\"/test/Wiki.jsp?page=WikiB%26%26PageB2\">PageB2</a>\n" +
						...
						"<hr />\n" +
						"<a class=\"wikipage\" href=\"/test/Wiki.jsp?page=Main%26%26PageA1\">Main&amp;&amp;PageA1</a>",
				res.trim());
